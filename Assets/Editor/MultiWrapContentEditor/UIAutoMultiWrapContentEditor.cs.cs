...
[CustomEditor(typeof(AutoMultiRowWrapContent), true)]
public class UIAutoMultiWrapContentEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.BeginHorizontal();
        NGUIEditorTools.DrawProperty("ItemWidth", serializedObject, "mItemWidth", GUILayout.Width(300f));
        GUILayout.EndHorizontal();
